    ...
    Result=rpc:call(FirstNode, floppy, clocksi_execute_tx,
                    [now(),
                     [{update, 11, Type, {increment, a}},
                      {update, 11, Type, {increment, a}},
                      {read, 11, crdt_pncounter},
                      {update, 12, Type, {increment, a}},
                      {read, 12, crdt_pncounter}]]),
    lager:info("*** ~p",[Result]),
