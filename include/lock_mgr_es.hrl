...
-define(LOCK_REQUEST_TIMEOUT_ES, 1500000).     % Locks requested by other DCs ( in microseconds -- 1 000 000 equals 1 second)
...
-define(LOCK_REQUIRED_TIMEOUT_ES,3000000).     % Locks requested by transactions of this DC (in microseconds -- 1 000 000 equals 1 second)
...
-define(LOCK_TRANSFER_FREQUENCY_ES,300).       % Sets how long lock_mgr_es waits between each time it sends requested locks to other DCs (in milliseconds -- 1 000 equals 1second)
...
-define(GET_LOCKS_INTERVAL_ES,250).         % Defines how long a transaction waits between retrying to get the locks
