...
-define(GET_LOCKS_FINAL_TRY_OPTION, true).     % Decides if the clocksi_interactive_coord waits for GET_LOCKS_FINAL_TRY_WAIT after a lock could not be acquired.
                                               % This is useful if GET_LOCKS_INTERVAL_ES is set very low in comparison to the time needed by DCs to communicate.
-define(GET_LOCKS_FINAL_TRY_WAIT, 300).        % Defines how long it waits until it does the last attempt to get the locks.
