...
-export_type(['ApbErrorResp'/0, 'ApbCounterUpdate'/0, 'ApbGetCounterResp'/0, 'ApbSetUpdate'/0, 'ApbGetSetResp'/0, 'ApbRegUpdate'/0, 'ApbGetRegResp'/0, 'ApbGetMVRegResp'/0, 'ApbMapKey'/0, 'ApbMapUpdate'/0, 'ApbMapNestedUpdate'/0, 'ApbGetMapResp'/0, 'ApbMapEntry'/0, 'ApbFlagUpdate'/0, 'ApbGetFlagResp'/0, 'ApbCrdtReset'/0, 'ApbOperationResp'/0, 'ApbTxnProperties'/0, 'ApbBoundObject'/0, 'ApbReadObjects'/0, 'ApbValidateOrReadObjects'/0, 'ApbUpdateOp'/0, 'ApbUpdateOperation'/0, 'ApbUpdateObjects'/0, 'ApbStartTransaction'/0, 'ApbAbortTransaction'/0, 'ApbCommitTransaction'/0, 'ApbStaticUpdateObjects'/0, 'ApbStaticReadObjects'/0, 'ApbStartTransactionResp'/0, 'ApbReadObjectResp'/0, 'ApbReadObjectsResp'/0, 'ApbValidateOrReadObjectsResp'/0, 'ApbCommitResp'/0, 'ApbStaticReadObjectsResp'/0, 'ApbCreateDC'/0, 'ApbCreateDCResp'/0, 'ApbGetConnectionDescriptor'/0, 'ApbGetConnectionDescriptorResp'/0, 'ApbConnectToDCs'/0, 'ApbConnectToDCsResp'/0]).

-spec encode_msg(#'ApbErrorResp'{} | #'ApbCounterUpdate'{} | #'ApbGetCounterResp'{} | #'ApbSetUpdate'{} | #'ApbGetSetResp'{} | #'ApbRegUpdate'{} | #'ApbGetRegResp'{} | #'ApbGetMVRegResp'{} | #'ApbMapKey'{} | #'ApbMapUpdate'{} | #'ApbMapNestedUpdate'{} | #'ApbGetMapResp'{} | #'ApbMapEntry'{} | #'ApbFlagUpdate'{} | #'ApbGetFlagResp'{} | #'ApbCrdtReset'{} | #'ApbOperationResp'{} | #'ApbTxnProperties'{} | #'ApbBoundObject'{} | #'ApbReadObjects'{} | #'ApbValidateOrReadObjects'{} | #'ApbUpdateOp'{} | #'ApbUpdateOperation'{} | #'ApbUpdateObjects'{} | #'ApbStartTransaction'{} | #'ApbAbortTransaction'{} | #'ApbCommitTransaction'{} | #'ApbStaticUpdateObjects'{} | #'ApbStaticReadObjects'{} | #'ApbStartTransactionResp'{} | #'ApbReadObjectResp'{} | #'ApbReadObjectsResp'{} | #'ApbValidateOrReadObjectsResp'{} | #'ApbCommitResp'{} | #'ApbStaticReadObjectsResp'{} | #'ApbCreateDC'{} | #'ApbCreateDCResp'{} | #'ApbGetConnectionDescriptor'{} | #'ApbGetConnectionDescriptorResp'{} | #'ApbConnectToDCs'{} | #'ApbConnectToDCsResp'{}) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
	  ...
	  encode_msg_ApbValidateOrReadObjects(id(Msg, TrUserData),
					      TrUserData);
      'ApbUpdateOp' ->
	  ...
	  encode_msg_ApbValidateOrReadObjectsResp(id(Msg,
						     TrUserData),
						  TrUserData);
      'ApbCommitResp' ->
...
encode_msg_ApbValidateOrReadObjects(Msg, TrUserData) ->
    encode_msg_ApbValidateOrReadObjects(Msg, <<>>,
					TrUserData).


encode_msg_ApbValidateOrReadObjects(#'ApbValidateOrReadObjects'{boundobjects
								    = F1,
								object_tokens =
								    F2,
    ...
    B1 = begin
	   ...
	   if TrF1 == [] -> Bin;
	      true ->
		  e_field_ApbValidateOrReadObjects_boundobjects(TrF1, Bin,
								TrUserData)
	   end
	 end,
    B2 = begin
	   ...
	   if TrF2 == [] -> B1;
	      true ->
		  e_field_ApbValidateOrReadObjects_object_tokens(TrF2, B1,
								 TrUserData)
	   end
	 end,
    begin
...
encode_msg_ApbValidateOrReadObjectsResp(Msg,
					TrUserData) ->
    encode_msg_ApbValidateOrReadObjectsResp(Msg, <<>>,
					    TrUserData).


encode_msg_ApbValidateOrReadObjectsResp(#'ApbValidateOrReadObjectsResp'{success
									    =
									    F1,
									objects
									    =
    ...
    B2 = begin
	   ...
	   if TrF2 == [] -> B1;
	      true ->
		  e_field_ApbValidateOrReadObjectsResp_objects(TrF2, B1,
							       TrUserData)
	   end
	 end,
    B3 = begin
	   ...
	   if TrF3 == [] -> B2;
	      true ->
		  e_field_ApbValidateOrReadObjectsResp_tokens(TrF3, B2,
							      TrUserData)
	   end
	 end,
    if F4 == undefined -> B3;
...
e_mfield_ApbValidateOrReadObjects_boundobjects(Msg, Bin,
					       TrUserData) ->
    SubBin = encode_msg_ApbBoundObject(Msg, <<>>,
				       TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
...
e_field_ApbValidateOrReadObjects_boundobjects([Elem
					       | Rest],
					      Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 =
	e_mfield_ApbValidateOrReadObjects_boundobjects(id(Elem,
							  TrUserData),
						       Bin2, TrUserData),
    e_field_ApbValidateOrReadObjects_boundobjects(Rest,
						  Bin3, TrUserData);
e_field_ApbValidateOrReadObjects_boundobjects([], Bin,
					      _TrUserData) ->
    Bin.

e_field_ApbValidateOrReadObjects_object_tokens([Elem
						| Rest],
					       Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_type_bytes(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_ApbValidateOrReadObjects_object_tokens(Rest,
						   Bin3, TrUserData);
e_field_ApbValidateOrReadObjects_object_tokens([], Bin,
					       _TrUserData) ->
    Bin.
...
e_mfield_ApbValidateOrReadObjectsResp_objects(Msg, Bin,
					      TrUserData) ->
    SubBin = encode_msg_ApbReadObjectResp(Msg, <<>>,
					  TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
...
e_field_ApbValidateOrReadObjectsResp_objects([Elem
					      | Rest],
					     Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 =
	e_mfield_ApbValidateOrReadObjectsResp_objects(id(Elem,
							 TrUserData),
						      Bin2, TrUserData),
    e_field_ApbValidateOrReadObjectsResp_objects(Rest, Bin3,
						 TrUserData);
e_field_ApbValidateOrReadObjectsResp_objects([], Bin,
					     _TrUserData) ->
    Bin.

e_field_ApbValidateOrReadObjectsResp_tokens([Elem
					     | Rest],
					    Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 26>>,
    Bin3 = e_type_bytes(id(Elem, TrUserData), Bin2,
			TrUserData),
    e_field_ApbValidateOrReadObjectsResp_tokens(Rest, Bin3,
						TrUserData);
e_field_ApbValidateOrReadObjectsResp_tokens([], Bin,
					    _TrUserData) ->
    Bin.
...
decode_msg_2_doit('ApbReadObjects', Bin, TrUserData) ->
    id(decode_msg_ApbReadObjects(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('ApbValidateOrReadObjects', Bin,
		  TrUserData) ->
    id(decode_msg_ApbValidateOrReadObjects(Bin, TrUserData),
       TrUserData);
...
decode_msg_2_doit('ApbReadObjectsResp', Bin,
    ...
    id(decode_msg_ApbReadObjectsResp(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('ApbValidateOrReadObjectsResp', Bin,
		  TrUserData) ->
    id(decode_msg_ApbValidateOrReadObjectsResp(Bin,
					       TrUserData),
       TrUserData);
...
decode_msg_ApbValidateOrReadObjects(Bin, TrUserData) ->
    dfp_read_field_def_ApbValidateOrReadObjects(Bin, 0, 0,
						id([], TrUserData),
						id([], TrUserData),
						id(undefined, TrUserData),
						TrUserData).

dfp_read_field_def_ApbValidateOrReadObjects(<<10,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, F@_3,
					    TrUserData) ->
    d_field_ApbValidateOrReadObjects_boundobjects(Rest, Z1,
						  Z2, F@_1, F@_2, F@_3,
						  TrUserData);
dfp_read_field_def_ApbValidateOrReadObjects(<<18,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, F@_3,
					    TrUserData) ->
    d_field_ApbValidateOrReadObjects_object_tokens(Rest, Z1,
						   Z2, F@_1, F@_2, F@_3,
						   TrUserData);
dfp_read_field_def_ApbValidateOrReadObjects(<<26,
					      Rest/binary>>,
					    Z1, Z2, F@_1, F@_2, F@_3,
					    TrUserData) ->
    d_field_ApbValidateOrReadObjects_transaction_descriptor(Rest,
							    Z1, Z2, F@_1, F@_2,
							    F@_3, TrUserData);
dfp_read_field_def_ApbValidateOrReadObjects(<<>>, 0, 0,
					    R1, R2, F@_3, TrUserData) ->
    #'ApbValidateOrReadObjects'{boundobjects =
				    lists_reverse(R1, TrUserData),
				object_tokens = lists_reverse(R2, TrUserData),
				transaction_descriptor = F@_3};
dfp_read_field_def_ApbValidateOrReadObjects(Other, Z1,
					    Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dg_read_field_def_ApbValidateOrReadObjects(Other, Z1,
					       Z2, F@_1, F@_2, F@_3,
					       TrUserData).

dg_read_field_def_ApbValidateOrReadObjects(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_ApbValidateOrReadObjects(Rest, N + 7,
					       X bsl N + Acc, F@_1, F@_2, F@_3,
					       TrUserData);
dg_read_field_def_ApbValidateOrReadObjects(<<0:1, X:7,
					     Rest/binary>>,
    ...
    case Key of
      10 ->
	  d_field_ApbValidateOrReadObjects_boundobjects(Rest, 0,
							0, F@_1, F@_2, F@_3,
							TrUserData);
      18 ->
	  d_field_ApbValidateOrReadObjects_object_tokens(Rest, 0,
							 0, F@_1, F@_2, F@_3,
							 TrUserData);
      26 ->
	  d_field_ApbValidateOrReadObjects_transaction_descriptor(Rest,
	  ...
	  case Key band 7 of
	    0 ->
		skip_varint_ApbValidateOrReadObjects(Rest, 0, 0, F@_1,
						     F@_2, F@_3, TrUserData);
	    1 ->
		skip_64_ApbValidateOrReadObjects(Rest, 0, 0, F@_1, F@_2,
						 F@_3, TrUserData);
	    2 ->
		skip_length_delimited_ApbValidateOrReadObjects(Rest, 0,
							       0, F@_1, F@_2,
							       F@_3,
							       TrUserData);
	    3 ->
		skip_group_ApbValidateOrReadObjects(Rest, Key bsr 3, 0,
						    F@_1, F@_2, F@_3,
						    TrUserData);
	    5 ->
		skip_32_ApbValidateOrReadObjects(Rest, 0, 0, F@_1, F@_2,
						 F@_3, TrUserData)
	  end
    end;
dg_read_field_def_ApbValidateOrReadObjects(<<>>, 0, 0,
					   R1, R2, F@_3, TrUserData) ->
    #'ApbValidateOrReadObjects'{boundobjects =
				    lists_reverse(R1, TrUserData),
				object_tokens = lists_reverse(R2, TrUserData),
...
d_field_ApbValidateOrReadObjects_boundobjects(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, F@_3,
					      TrUserData)
    when N < 57 ->
    d_field_ApbValidateOrReadObjects_boundobjects(Rest,
						  N + 7, X bsl N + Acc, F@_1,
						  F@_2, F@_3, TrUserData);
d_field_ApbValidateOrReadObjects_boundobjects(<<0:1,
						X:7, Rest/binary>>,
    ...
    dfp_read_field_def_ApbValidateOrReadObjects(RestF, 0, 0,
						cons(NewFValue, Prev,
						     TrUserData),
						F@_2, F@_3, TrUserData).

d_field_ApbValidateOrReadObjects_object_tokens(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, F@_3,
					       TrUserData)
    when N < 57 ->
    d_field_ApbValidateOrReadObjects_object_tokens(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   F@_2, F@_3, TrUserData);
d_field_ApbValidateOrReadObjects_object_tokens(<<0:1,
						 X:7, Rest/binary>>,
...
d_field_ApbValidateOrReadObjects_transaction_descriptor(<<1:1,
							  X:7, Rest/binary>>,
							N, Acc, F@_1, F@_2,
							F@_3, TrUserData)
    when N < 57 ->
    d_field_ApbValidateOrReadObjects_transaction_descriptor(Rest,
							    ...
							    F@_2, F@_3,
							    TrUserData);
d_field_ApbValidateOrReadObjects_transaction_descriptor(<<0:1,
							  X:7, Rest/binary>>,
							N, Acc, F@_1, F@_2, _,
							TrUserData) ->
    {NewFValue, RestF} = begin
...
skip_varint_ApbValidateOrReadObjects(<<1:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_ApbValidateOrReadObjects(Rest, Z1, Z2, F@_1,
					 F@_2, F@_3, TrUserData);
skip_varint_ApbValidateOrReadObjects(<<0:1, _:7,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_ApbValidateOrReadObjects(Rest, Z1,
						Z2, F@_1, F@_2, F@_3,
						TrUserData).

skip_length_delimited_ApbValidateOrReadObjects(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, F@_3,
					       TrUserData)
    when N < 57 ->
    skip_length_delimited_ApbValidateOrReadObjects(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   F@_2, F@_3, TrUserData);
skip_length_delimited_ApbValidateOrReadObjects(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, F@_3,
					       TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ApbValidateOrReadObjects(Rest2, 0, 0,
						F@_1, F@_2, F@_3, TrUserData).

skip_group_ApbValidateOrReadObjects(Bin, FNum, Z2, F@_1,
				    F@_2, F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ApbValidateOrReadObjects(Rest, 0, Z2,
						F@_1, F@_2, F@_3, TrUserData).

skip_32_ApbValidateOrReadObjects(<<_:32, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_ApbValidateOrReadObjects(Rest, Z1,
						Z2, F@_1, F@_2, F@_3,
						TrUserData).

skip_64_ApbValidateOrReadObjects(<<_:64, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_ApbValidateOrReadObjects(Rest, Z1,
						Z2, F@_1, F@_2, F@_3,
						TrUserData).
...
decode_msg_ApbValidateOrReadObjectsResp(Bin,
					TrUserData) ->
    dfp_read_field_def_ApbValidateOrReadObjectsResp(Bin, 0,
						    0,
						    id(undefined, TrUserData),
						    id([], TrUserData),
						    id([], TrUserData),
...
dfp_read_field_def_ApbValidateOrReadObjectsResp(<<8,
						  Rest/binary>>,
						Z1, Z2, F@_1, F@_2, F@_3, F@_4,
						TrUserData) ->
    d_field_ApbValidateOrReadObjectsResp_success(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 TrUserData);
dfp_read_field_def_ApbValidateOrReadObjectsResp(<<18,
						  Rest/binary>>,
						Z1, Z2, F@_1, F@_2, F@_3, F@_4,
						TrUserData) ->
    d_field_ApbValidateOrReadObjectsResp_objects(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 TrUserData);
dfp_read_field_def_ApbValidateOrReadObjectsResp(<<26,
						  Rest/binary>>,
						Z1, Z2, F@_1, F@_2, F@_3, F@_4,
						TrUserData) ->
    d_field_ApbValidateOrReadObjectsResp_tokens(Rest, Z1,
						Z2, F@_1, F@_2, F@_3, F@_4,
						TrUserData);
dfp_read_field_def_ApbValidateOrReadObjectsResp(<<32,
						  Rest/binary>>,
						Z1, Z2, F@_1, F@_2, F@_3, F@_4,
						TrUserData) ->
    d_field_ApbValidateOrReadObjectsResp_errorcode(Rest, Z1,
						   Z2, F@_1, F@_2, F@_3, F@_4,
						   TrUserData);
dfp_read_field_def_ApbValidateOrReadObjectsResp(<<>>, 0,
						0, F@_1, R1, R2, F@_4,
						TrUserData) ->
    #'ApbValidateOrReadObjectsResp'{success = F@_1,
				    objects = lists_reverse(R1, TrUserData),
				    tokens = lists_reverse(R2, TrUserData),
				    errorcode = F@_4};
dfp_read_field_def_ApbValidateOrReadObjectsResp(Other,
						Z1, Z2, F@_1, F@_2, F@_3, F@_4,
						TrUserData) ->
    dg_read_field_def_ApbValidateOrReadObjectsResp(Other,
						   Z1, Z2, F@_1, F@_2, F@_3,
						   F@_4, TrUserData).

dg_read_field_def_ApbValidateOrReadObjectsResp(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, F@_3, F@_4,
					       TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_ApbValidateOrReadObjectsResp(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   F@_2, F@_3, F@_4,
						   TrUserData);
dg_read_field_def_ApbValidateOrReadObjectsResp(<<0:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, F@_3, F@_4,
					       TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_ApbValidateOrReadObjectsResp_success(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       TrUserData);
      18 ->
	  d_field_ApbValidateOrReadObjectsResp_objects(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       TrUserData);
      26 ->
	  d_field_ApbValidateOrReadObjectsResp_tokens(Rest, 0, 0,
						      F@_1, F@_2, F@_3, F@_4,
						      TrUserData);
      32 ->
	  d_field_ApbValidateOrReadObjectsResp_errorcode(Rest, 0,
							 0, F@_1, F@_2, F@_3,
							 F@_4, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_ApbValidateOrReadObjectsResp(Rest, 0, 0,
							 F@_1, F@_2, F@_3, F@_4,
							 TrUserData);
	    1 ->
		skip_64_ApbValidateOrReadObjectsResp(Rest, 0, 0, F@_1,
						     F@_2, F@_3, F@_4,
						     TrUserData);
	    2 ->
		skip_length_delimited_ApbValidateOrReadObjectsResp(Rest,
								   0, 0, F@_1,
								   F@_2, F@_3,
								   F@_4,
								   TrUserData);
	    3 ->
		skip_group_ApbValidateOrReadObjectsResp(Rest, Key bsr 3,
							0, F@_1, F@_2, F@_3,
							F@_4, TrUserData);
	    5 ->
		skip_32_ApbValidateOrReadObjectsResp(Rest, 0, 0, F@_1,
						     F@_2, F@_3, F@_4,
						     TrUserData)
	  end
    end;
dg_read_field_def_ApbValidateOrReadObjectsResp(<<>>, 0,
					       0, F@_1, R1, R2, F@_4,
					       TrUserData) ->
    #'ApbValidateOrReadObjectsResp'{success = F@_1,
				    objects = lists_reverse(R1, TrUserData),
...
d_field_ApbValidateOrReadObjectsResp_success(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     TrUserData)
    when N < 57 ->
    d_field_ApbValidateOrReadObjectsResp_success(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, F@_4, TrUserData);
d_field_ApbValidateOrReadObjectsResp_success(<<0:1, X:7,
					       Rest/binary>>,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
			     TrUserData),
			  Rest},
    dfp_read_field_def_ApbValidateOrReadObjectsResp(RestF,
						    0, 0, NewFValue, F@_2, F@_3,
						    F@_4, TrUserData).

d_field_ApbValidateOrReadObjectsResp_objects(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     TrUserData)
    when N < 57 ->
    d_field_ApbValidateOrReadObjectsResp_objects(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, F@_4, TrUserData);
d_field_ApbValidateOrReadObjectsResp_objects(<<0:1, X:7,
					       Rest/binary>>,
...
d_field_ApbValidateOrReadObjectsResp_tokens(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, F@_3, F@_4,
					    TrUserData)
    when N < 57 ->
    d_field_ApbValidateOrReadObjectsResp_tokens(Rest, N + 7,
						X bsl N + Acc, F@_1, F@_2, F@_3,
						F@_4, TrUserData);
d_field_ApbValidateOrReadObjectsResp_tokens(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, Prev, F@_4,
					    TrUserData) ->
    {NewFValue, RestF} = begin
...
d_field_ApbValidateOrReadObjectsResp_errorcode(<<1:1,
						 X:7, Rest/binary>>,
					       N, Acc, F@_1, F@_2, F@_3, F@_4,
					       TrUserData)
    when N < 57 ->
    d_field_ApbValidateOrReadObjectsResp_errorcode(Rest,
						   N + 7, X bsl N + Acc, F@_1,
						   F@_2, F@_3, F@_4,
						   TrUserData);
d_field_ApbValidateOrReadObjectsResp_errorcode(<<0:1,
						 X:7, Rest/binary>>,
...
skip_varint_ApbValidateOrReadObjectsResp(<<1:1, _:7,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					 TrUserData) ->
    skip_varint_ApbValidateOrReadObjectsResp(Rest, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4,
					     TrUserData);
skip_varint_ApbValidateOrReadObjectsResp(<<0:1, _:7,
					   Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					 TrUserData) ->
    dfp_read_field_def_ApbValidateOrReadObjectsResp(Rest,
						    Z1, Z2, F@_1, F@_2, F@_3,
						    F@_4, TrUserData).

skip_length_delimited_ApbValidateOrReadObjectsResp(<<1:1,
						     X:7, Rest/binary>>,
						   N, Acc, F@_1, F@_2, F@_3,
						   F@_4, TrUserData)
    when N < 57 ->
    skip_length_delimited_ApbValidateOrReadObjectsResp(Rest,
						       ...
						       F@_1, F@_2, F@_3, F@_4,
						       TrUserData);
skip_length_delimited_ApbValidateOrReadObjectsResp(<<0:1,
						     X:7, Rest/binary>>,
						   N, Acc, F@_1, F@_2, F@_3,
						   F@_4, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ApbValidateOrReadObjectsResp(Rest2,
						    0, 0, F@_1, F@_2, F@_3,
						    F@_4, TrUserData).

skip_group_ApbValidateOrReadObjectsResp(Bin, FNum, Z2,
					F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ApbValidateOrReadObjectsResp(Rest, 0,
						    Z2, F@_1, F@_2, F@_3, F@_4,
						    TrUserData).

skip_32_ApbValidateOrReadObjectsResp(<<_:32,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    dfp_read_field_def_ApbValidateOrReadObjectsResp(Rest,
...
skip_64_ApbValidateOrReadObjectsResp(<<_:64,
				       Rest/binary>>,
				     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				     TrUserData) ->
    dfp_read_field_def_ApbValidateOrReadObjectsResp(Rest,
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      'ApbValidateOrReadObjects' ->
	  merge_msg_ApbValidateOrReadObjects(Prev, New,
					     TrUserData);
      'ApbUpdateOp' ->
      ...
      'ApbValidateOrReadObjectsResp' ->
	  merge_msg_ApbValidateOrReadObjectsResp(Prev, New,
						 TrUserData);
      'ApbCommitResp' ->
...
merge_msg_ApbValidateOrReadObjects(#'ApbValidateOrReadObjects'{boundobjects
								   =
								   PFboundobjects,
							       object_tokens =
								   PFobject_tokens},
    ...
    #'ApbValidateOrReadObjects'{boundobjects =
				...
				object_tokens =
				    if PFobject_tokens /= undefined,
				       NFobject_tokens /= undefined ->
					   'erlang_++'(PFobject_tokens,
						       NFobject_tokens,
						       TrUserData);
...
merge_msg_ApbValidateOrReadObjectsResp(#'ApbValidateOrReadObjectsResp'{objects
									   =
									   PFobjects,
								       tokens =
									   PFtokens,
									   ...
									   =
									   PFerrorcode},
				       #'ApbValidateOrReadObjectsResp'{success =
									   NFsuccess,
								       objects =
									   NFobjects,
								       tokens =
									   ...
									   NFerrorcode},
				       TrUserData) ->
    #'ApbValidateOrReadObjectsResp'{success = NFsuccess,
				    objects =
					if PFobjects /= undefined,
					   NFobjects /= undefined ->
					       'erlang_++'(PFobjects, NFobjects,
				    ...
				    tokens =
					if PFtokens /= undefined,
					   NFtokens /= undefined ->
					       'erlang_++'(PFtokens, NFtokens,
							   TrUserData);
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      'ApbValidateOrReadObjects' ->
	  v_msg_ApbValidateOrReadObjects(Msg, [MsgName],
					 TrUserData);
      'ApbUpdateOp' ->
      ...
      'ApbValidateOrReadObjectsResp' ->
	  v_msg_ApbValidateOrReadObjectsResp(Msg, [MsgName],
					     TrUserData);
      'ApbCommitResp' ->
...
v_msg_ApbValidateOrReadObjects(#'ApbValidateOrReadObjects'{boundobjects
							       = F1,
							   object_tokens = F2,
							   transaction_descriptor
							       = F3},
    ...
    if is_list(F2) ->
	   _ = [v_type_bytes(Elem, [object_tokens | Path],
			     TrUserData)
		|| Elem <- F2],
	   ok;
       true ->
    ...
    v_type_bytes(F3, [transaction_descriptor | Path],
		 TrUserData),
    ok;
...
v_msg_ApbValidateOrReadObjectsResp(#'ApbValidateOrReadObjectsResp'{success
								       = F1,
								   objects = F2,
								   tokens = F3,
								   errorcode =
    ...
    if is_list(F3) ->
	   _ = [v_type_bytes(Elem, [tokens | Path], TrUserData)
		|| Elem <- F3],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, bytes}, F3,
    ...
    if F4 == undefined -> ok;
       true ->
	   v_type_uint32(F4, [errorcode | Path], TrUserData)
    end,
    ok;
v_msg_ApbValidateOrReadObjectsResp(X, Path,
				   _TrUserData) ->
    mk_type_error({expected_msg,
		   'ApbValidateOrReadObjectsResp'},
		  X, Path).
    ...
    [{{enum, 'CRDT_type'},
     ...
     {{msg, 'ApbValidateOrReadObjects'},
      [#field{name = boundobjects, fnum = 1, rnum = 2,
	      type = {msg, 'ApbBoundObject'}, occurrence = repeated,
	      opts = []},
       #field{name = object_tokens, fnum = 2, rnum = 3,
	      type = bytes, occurrence = repeated, opts = []},
       #field{name = transaction_descriptor, fnum = 3,
	      rnum = 4, type = bytes, occurrence = required,
	      opts = []}]},
     {{msg, 'ApbUpdateOp'},
     ...
     {{msg, 'ApbValidateOrReadObjectsResp'},
      [#field{name = success, fnum = 1, rnum = 2, type = bool,
       ...
       #field{name = objects, fnum = 2, rnum = 3,
	      type = {msg, 'ApbReadObjectResp'},
	      occurrence = repeated, opts = []},
       #field{name = tokens, fnum = 3, rnum = 4, type = bytes,
	      occurrence = repeated, opts = []},
       #field{name = errorcode, fnum = 4, rnum = 5,
	      type = uint32, occurrence = optional, opts = []}]},
     {{msg, 'ApbCommitResp'},
      [#field{name = success, fnum = 1, rnum = 2, type = bool,
	      occurrence = required, opts = []},
...
get_msg_names() ->
    ['ApbErrorResp', 'ApbCounterUpdate',
     ...
     'ApbValidateOrReadObjects', 'ApbUpdateOp',
     ...
     'ApbValidateOrReadObjectsResp', 'ApbCommitResp',
     'ApbStaticReadObjectsResp', 'ApbCreateDC',
     'ApbCreateDCResp', 'ApbGetConnectionDescriptor',
...
fqbin_to_msg_name(<<"ApbValidateOrReadObjects">>) ->
    'ApbValidateOrReadObjects';
...
fqbin_to_msg_name(<<"ApbValidateOrReadObjectsResp">>) ->
    'ApbValidateOrReadObjectsResp';
...
msg_name_to_fqbin('ApbValidateOrReadObjects') ->
    <<"ApbValidateOrReadObjects">>;
...
msg_name_to_fqbin('ApbValidateOrReadObjectsResp') ->
    <<"ApbValidateOrReadObjectsResp">>;
...
get_msg_containment("antidote") ->
    ['ApbAbortTransaction', 'ApbBoundObject',
     ...
     'ApbUpdateOperation', 'ApbValidateOrReadObjects',
     'ApbValidateOrReadObjectsResp'];
