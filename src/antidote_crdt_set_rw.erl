...
elems_with_removed_tombstones([E|ElemsRest]=Elems, [{K, Ts}|DictRest]=Dict, ResetTokens) ->
    if
        E == K ->
...
add_elems([{E, RemovedTombstones}|ElemsRest]=Elems, [{K, Ts}|DictRest]=Dict, NewTombs, NewEntryTombs) ->
    if
        E == K ->
