...
encode_msg(Msg, Opts) ->
    ...
    case Msg of
      #'ApbErrorResp'{} ->
	  e_msg_ApbErrorResp(Msg, TrUserData);
      #'ApbCounterUpdate'{} ->
      ...
      #'ApbMapKey'{} -> e_msg_ApbMapKey(Msg, TrUserData);
      #'ApbMapUpdate'{} ->
      ...
      #'ApbMapEntry'{} -> e_msg_ApbMapEntry(Msg, TrUserData);
      #'ApbFlagUpdate'{} ->
	  e_msg_ApbFlagUpdate(Msg, TrUserData);
      #'ApbGetFlagResp'{} ->
	  e_msg_ApbGetFlagResp(Msg, TrUserData);
      #'ApbCrdtReset'{} ->
	  e_msg_ApbCrdtReset(Msg, TrUserData);
      #'ApbOperationResp'{} ->
      ...
      #'ApbUpdateOp'{} -> e_msg_ApbUpdateOp(Msg, TrUserData);
      #'ApbUpdateOperation'{} ->
...
e_msg_ApbErrorResp(#'ApbErrorResp'{errmsg = F1,
				   errcode = F2},
		   Bin, TrUserData) ->
    B1 = begin
...
e_msg_ApbMapKey(#'ApbMapKey'{key = F1, type = F2}, Bin,
    ...
    begin
      TrF2 = id(F2, TrUserData),
      e_enum_CRDT_type(TrF2, <<B1/binary, 16>>)
    end.
...
e_enum_CRDT_type('MVREG', Bin) -> <<Bin/binary, 6>>;
e_enum_CRDT_type('GMAP', Bin) -> <<Bin/binary, 8>>;
e_enum_CRDT_type('RWSET', Bin) -> <<Bin/binary, 10>>;
e_enum_CRDT_type('RRMAP', Bin) -> <<Bin/binary, 11>>;
e_enum_CRDT_type('FATCOUNTER', Bin) ->
    <<Bin/binary, 12>>;
e_enum_CRDT_type('FLAG_EW', Bin) -> <<Bin/binary, 13>>;
e_enum_CRDT_type('FLAG_DW', Bin) -> <<Bin/binary, 14>>;
e_enum_CRDT_type(V, Bin) -> e_varint(V, Bin).

'e_enum_ApbSetUpdate.SetOpType'('ADD', Bin) ->
    <<Bin/binary, 1>>;
'e_enum_ApbSetUpdate.SetOpType'('REMOVE', Bin) ->
    <<Bin/binary, 2>>;
'e_enum_ApbSetUpdate.SetOpType'(V, Bin) ->
    e_varint(V, Bin).
...
decode_msg_2_doit('ApbErrorResp', Bin, TrUserData) ->
    d_msg_ApbErrorResp(Bin, TrUserData);
...
d_field_ApbMapKey_type(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = {d_enum_CRDT_type(begin
...
verify_msg(Msg, Opts) ->
    ...
    case Msg of
      #'ApbErrorResp'{} ->
	  v_msg_ApbErrorResp(Msg, ['ApbErrorResp'], TrUserData);
      #'ApbCounterUpdate'{} ->
	  v_msg_ApbCounterUpdate(Msg, ['ApbCounterUpdate'],
				 TrUserData);
      #'ApbGetCounterResp'{} ->
	  v_msg_ApbGetCounterResp(Msg, ['ApbGetCounterResp'],
				  TrUserData);
      #'ApbSetUpdate'{} ->
	  v_msg_ApbSetUpdate(Msg, ['ApbSetUpdate'], TrUserData);
      #'ApbGetSetResp'{} ->
	  v_msg_ApbGetSetResp(Msg, ['ApbGetSetResp'], TrUserData);
      #'ApbRegUpdate'{} ->
	  v_msg_ApbRegUpdate(Msg, ['ApbRegUpdate'], TrUserData);
      #'ApbGetRegResp'{} ->
	  v_msg_ApbGetRegResp(Msg, ['ApbGetRegResp'], TrUserData);
      #'ApbGetMVRegResp'{} ->
	  v_msg_ApbGetMVRegResp(Msg, ['ApbGetMVRegResp'],
				TrUserData);
      #'ApbMapKey'{} ->
	  v_msg_ApbMapKey(Msg, ['ApbMapKey'], TrUserData);
      #'ApbMapUpdate'{} ->
	  v_msg_ApbMapUpdate(Msg, ['ApbMapUpdate'], TrUserData);
      #'ApbMapNestedUpdate'{} ->
	  v_msg_ApbMapNestedUpdate(Msg, ['ApbMapNestedUpdate'],
				   TrUserData);
      #'ApbGetMapResp'{} ->
	  v_msg_ApbGetMapResp(Msg, ['ApbGetMapResp'], TrUserData);
      #'ApbMapEntry'{} ->
	  v_msg_ApbMapEntry(Msg, ['ApbMapEntry'], TrUserData);
      #'ApbFlagUpdate'{} ->
	  v_msg_ApbFlagUpdate(Msg, ['ApbFlagUpdate'], TrUserData);
      #'ApbGetFlagResp'{} ->
	  v_msg_ApbGetFlagResp(Msg, ['ApbGetFlagResp'],
			       TrUserData);
      #'ApbCrdtReset'{} ->
	  v_msg_ApbCrdtReset(Msg, ['ApbCrdtReset'], TrUserData);
      #'ApbOperationResp'{} ->
	  v_msg_ApbOperationResp(Msg, ['ApbOperationResp'],
				 TrUserData);
      #'ApbTxnProperties'{} ->
	  v_msg_ApbTxnProperties(Msg, ['ApbTxnProperties'],
				 TrUserData);
      #'ApbBoundObject'{} ->
	  v_msg_ApbBoundObject(Msg, ['ApbBoundObject'],
			       TrUserData);
      #'ApbReadObjects'{} ->
	  v_msg_ApbReadObjects(Msg, ['ApbReadObjects'],
			       TrUserData);
      #'ApbUpdateOp'{} ->
	  v_msg_ApbUpdateOp(Msg, ['ApbUpdateOp'], TrUserData);
      #'ApbUpdateOperation'{} ->
	  v_msg_ApbUpdateOperation(Msg, ['ApbUpdateOperation'],
				   TrUserData);
      #'ApbUpdateObjects'{} ->
	  v_msg_ApbUpdateObjects(Msg, ['ApbUpdateObjects'],
				 TrUserData);
      #'ApbStartTransaction'{} ->
	  v_msg_ApbStartTransaction(Msg, ['ApbStartTransaction'],
				    TrUserData);
      #'ApbAbortTransaction'{} ->
	  v_msg_ApbAbortTransaction(Msg, ['ApbAbortTransaction'],
				    TrUserData);
      #'ApbCommitTransaction'{} ->
	  v_msg_ApbCommitTransaction(Msg,
				     ['ApbCommitTransaction'], TrUserData);
      #'ApbStaticUpdateObjects'{} ->
	  v_msg_ApbStaticUpdateObjects(Msg,
				       ['ApbStaticUpdateObjects'], TrUserData);
      #'ApbStaticReadObjects'{} ->
	  v_msg_ApbStaticReadObjects(Msg,
				     ['ApbStaticReadObjects'], TrUserData);
      #'ApbStartTransactionResp'{} ->
	  v_msg_ApbStartTransactionResp(Msg,
					['ApbStartTransactionResp'],
					TrUserData);
      #'ApbReadObjectResp'{} ->
	  v_msg_ApbReadObjectResp(Msg, ['ApbReadObjectResp'],
				  TrUserData);
      #'ApbReadObjectsResp'{} ->
	  v_msg_ApbReadObjectsResp(Msg, ['ApbReadObjectsResp'],
				   TrUserData);
      #'ApbCommitResp'{} ->
	  v_msg_ApbCommitResp(Msg, ['ApbCommitResp'], TrUserData);
      #'ApbStaticReadObjectsResp'{} ->
...
v_msg_ApbCounterUpdate(#'ApbCounterUpdate'{inc = F1},
		       Path, _) ->
    if F1 == undefined -> ok;
       true -> v_type_sint64(F1, [inc | Path])
    end,
    ok;
...
v_msg_ApbGetCounterResp(#'ApbGetCounterResp'{value =
						 F1},
			Path, _) ->
    v_type_sint32(F1, [value | Path]), ok;
...
v_msg_ApbSetUpdate(#'ApbSetUpdate'{optype = F1,
    ...
    if is_list(F2) ->
	   _ = [v_type_bytes(Elem, [adds | Path]) || Elem <- F2],
	   ok;
       true ->
    ...
    if is_list(F3) ->
	   _ = [v_type_bytes(Elem, [rems | Path]) || Elem <- F3],
	   ok;
       true ->
...
v_msg_ApbGetSetResp(#'ApbGetSetResp'{value = F1}, Path,
		    _) ->
    if is_list(F1) ->
	   _ = [v_type_bytes(Elem, [value | Path]) || Elem <- F1],
	   ok;
       true ->
...
v_msg_ApbGetMVRegResp(#'ApbGetMVRegResp'{values = F1},
		      Path, _) ->
    if is_list(F1) ->
	   _ = [v_type_bytes(Elem, [values | Path]) || Elem <- F1],
	   ok;
       true ->
	   mk_type_error({invalid_list_of, bytes}, F1,
			 [values | Path])
...
v_msg_ApbOperationResp(#'ApbOperationResp'{success = F1,
    ...
    if F2 == undefined -> ok;
       true -> v_type_uint32(F2, [errorcode | Path])
    end,
    ok.
...
v_msg_ApbTxnProperties(#'ApbTxnProperties'{read_write =
		       ...
		       Path, _) ->
    if F1 == undefined -> ok;
       true -> v_type_uint32(F1, [read_write | Path])
    end,
    if F2 == undefined -> ok;
       true -> v_type_uint32(F2, [red_blue | Path])
    end,
    ok;
...
v_msg_ApbStartTransaction(#'ApbStartTransaction'{timestamp
			  ...
			  Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> v_type_bytes(F1, [timestamp | Path])
    end,
    if F2 == undefined -> ok;
       true ->
...
v_msg_ApbAbortTransaction(#'ApbAbortTransaction'{transaction_descriptor
						     = F1},
			  Path, _) ->
    v_type_bytes(F1, [transaction_descriptor | Path]), ok.
...
v_msg_ApbCommitResp(#'ApbCommitResp'{success = F1,
    ...
    v_type_bool(F1, [success | Path]),
    if F2 == undefined -> ok;
       true -> v_type_bytes(F2, [commit_time | Path])
    end,
    if F3 == undefined -> ok;
       true -> v_type_uint32(F3, [errorcode | Path])
    end,
...
v_enum_CRDT_type('LWWREG', _Path) -> ok;
v_enum_CRDT_type('MVREG', _Path) -> ok;
v_enum_CRDT_type('GMAP', _Path) -> ok;
v_enum_CRDT_type('RWSET', _Path) -> ok;
v_enum_CRDT_type('RRMAP', _Path) -> ok;
v_enum_CRDT_type('FATCOUNTER', _Path) -> ok;
v_enum_CRDT_type('FLAG_EW', _Path) -> ok;
v_enum_CRDT_type('FLAG_DW', _Path) -> ok;
v_enum_CRDT_type(V, Path) when is_integer(V) ->
    v_type_sint32(V, Path);
v_enum_CRDT_type(X, Path) ->
    mk_type_error({invalid_enum, 'CRDT_type'}, X, Path).

-dialyzer({nowarn_function,'v_enum_ApbSetUpdate.SetOpType'/2}).
'v_enum_ApbSetUpdate.SetOpType'('ADD', _Path) -> ok;
'v_enum_ApbSetUpdate.SetOpType'('REMOVE', _Path) -> ok;
'v_enum_ApbSetUpdate.SetOpType'(V, Path)
    when is_integer(V) ->
    v_type_sint32(V, Path);
'v_enum_ApbSetUpdate.SetOpType'(X, Path) ->
