...
init([Partition]) ->
    ...
    {ok, #state { partition=Partition, log=Log, lclock=0 }}.
...
handle_command({append, Key, Payload}, _Sender, #state{log=Log, lclock=LC}=_State) ->
    ...
    State1=#state{log=Log, lclock=NewClock},
